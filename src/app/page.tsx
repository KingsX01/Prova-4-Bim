      ...
      <div className="flex flex-col items-center justify-center gap-[6rem] lg:gap-[3rem] lg:bg-white p-6 rounded-3xl">
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-4 items-center">
            <button className="bg-fuchsia-600 text-white w-[359px] h-[68px] font-semibold rounded-lg lg:w-[430px]">Entrar</button>
            <button className="bg-white text-fuchsia-600 w-[359px] h-[68px] font-extrabold rounded-lg lg:w-[430px] lg:bg-zinc-300 lg:h-[50px]">Esqueci minha senha</button>
          </div>
        </div>
      </div>
    </main>
